...
extension LoadifyKit {
    
    public struct ColorKit {
        public static let appBackground = Color("app_background", bundle: .module)
        public static let greyText = Color("grey_text", bundle: .module)
        public static let textfieldBackground = Color("textfield_background", bundle: .module)
